    ...
    >
      <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        ...
        <p className="mb-4 leading-relaxed">
          I&apos;m a senior at the City College of New York, pursuing a
          ...
          creating Backend, Frontend, Mobile, Cloud, and DevOps applications.
          I&apos;m always eager to learn something new every day! <br />
